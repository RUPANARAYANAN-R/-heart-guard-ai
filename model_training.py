# 🤖 model_training.py (Large Dataset Version)
...
print("Generating a much larger synthetic dataset...")
np.random.seed(42)
# Increased sample size to 20,000 for more robust training
num_samples = 20000 
...
print("Preprocessing the large dataset...")
...
# --- 3. Model Training ---
print("Training the model on the large dataset...")
# RandomForestClassifier is robust and handles larger datasets well.
...
print(f"\nModel Accuracy on Large Dataset: {accuracy:.4f}")
print("Classification Report:")
print(report)

# --- 5. Save the Model and Scaler ---
print("Saving the new model and supporting files...")
joblib.dump(model, 'heart_risk_model.joblib')
joblib.dump(scaler, 'scaler.joblib')
joblib.dump(imputer, 'imputer.joblib')
df.to_csv('synthetic_heart_data.csv', index=False) 

print("\n✅ Model re-training with large dataset complete!")